...
public class UpdateRouteMapPage extends AbstractPage {
	...
	protected void onInitialize() {
		...
		form.add(blockIdChoice);
				...
				final TimePicker blockEnterTimepicker = new TimePicker("block-enter-timepicker", Model.of(calendar.getTime()), "hh:mm");
				form.add(blockEnterTimepicker);
				
				final TimePicker blockLeaveTimepicker = new TimePicker("block-leave-timepicker", Model.of(calendar.getTime()), "hh:mm");
...
//					rmElement.setBlockLeaveTime(new Time(01, 30, 00));
					Date date = blockEnterTimepicker.getModelObject();
					...
					rmElement.setBlockLeaveTime(time);
							// 			 /\
// засетать время правильным образом     |
