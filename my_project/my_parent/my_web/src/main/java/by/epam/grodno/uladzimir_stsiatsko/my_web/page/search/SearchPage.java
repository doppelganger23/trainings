...
public class SearchPage extends AbstractPage {
	...
	protected void onInitialize() {
		...
		form.add(new TextField<String>("departureStation"));
		form.add(new TextField<String>("destinationStation"));
		...
		form.add(new SubmitLink("submit-button") {
			...
			public void onSubmit() {
				...
				srService.find(newRequest).forEach(new Consumer<SearchResult>() {
					@Override
